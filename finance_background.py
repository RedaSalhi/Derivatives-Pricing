...
if selected_section == "Overview" or selected_section == "Strategies":
    # ----------------------
    # Strategy Section
    # ----------------------
    with st.container():
...
if selected_section == "Overview" or selected_section == "Risk-Neutral":
    # ----------------------
...
if selected_section == "Overview" or selected_section == "Engineering":
    # ----------------------
    # Engineering Section
    # ----------------------
    with st.container():
