...
# ------------------------------------------------------------------------------
def price_coupon_bond(r0, t, a, lam, sigma, maturity=5, face=1.0, coupon, dt=0.5): #need extraction from pricing.models.interest_rates.analytical_vasicek import price_coupon_bond
